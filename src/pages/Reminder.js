...
const TABLE_HEAD = [
  ...
  { id: '', label: 'Activity', alignRight: false },
  {
    id: 'phoneNumber',
    numeric: true,
    label: 'Mobile Number',
...
export default function Reminder() {
  ...
  const TableData = async () => {
    const response = await getResponse('/user/remainder', {});
                    ...
                    return (
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" sx={{ background: rowColor }}>
                        ...
                        <TableCellStyle align="center">
                          <UserMoreMenu item={row._id} reCallFun={() => TableData()} />
                        </TableCellStyle>
